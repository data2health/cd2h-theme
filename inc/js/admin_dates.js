...
var WidgetsUploader = WidgetsUploader || {};

/**
* MediaUploader class, constructor
* @return void
*/
WidgetsUploader.mediaUploader = function( frameOptions ) {
  'use strict';
...
jQuery.extend( WidgetsUploader.mediaUploader.prototype, {
...
// Initialization
WidgetsUploader.fileUploader = new WidgetsUploader.mediaUploader();
WidgetsUploader.imageUploader = new WidgetsUploader.mediaUploader( {
